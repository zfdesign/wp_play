...
// Social Links
function zfd_social_links($content) {
    if(is_single()) {
        $content .= '<div class="social-links">
            <span class="g-plus"><img src="" alt="Share on g+" /></span>
            <span class="facebook"><img src="" alt="Share on facebook" /></span>
            <span class="twitter"><img src="" alt="Share on twitter" /></span>
        </div>';
    }
...
add_filter('thematic-post', 'zfd_social_links', 90);
